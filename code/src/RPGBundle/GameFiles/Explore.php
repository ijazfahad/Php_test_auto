...
class Explore
{
    ...
    public function startgame($characterName,$Uhealth,$Uexp,$UProgress,$Upotions)
    {
        ...
        $health->setHealth($Uhealth);
        $gameProgress->setGameProgress($UProgress);
        $experience->setExperience($Uexp);
        $healthPotion->setHealthPotions($Upotions);
        $mapcheck = $gameProgress->getGameProgress();

        $mapExp = 2*$gameProgress->getGameProgress();
           ...
           // echo" You are in the dungeons right now....\n";
            ...
            if($val==5) {
                ...
                if($conn =  mysqli_connect($mysql_host,$mysql_user,$mysql_password,$mydb,null,null))
                {
                ...
                else
                {
                    ...
                    echo" Creating table inside database...\n";
                    $this->createtable();
                }

                $charN = "'" . $character->getCharacterName() . "'";
                $exp = $experience->getExperience();
                $ht = $health->getHealth();
                $hp = $healthPotion->getHealthPotions();
                $gp = $gameProgress->getGameProgress();

                //  echo $charN." ".$exp." ".$ht." ".$ht." ".$hp." ".$gp."\n";
                ...
                if (mysqli_connect_errno()) {
                    echo"Either the internet is down or you aren't logged in your database\n\n\n";
                    exit('Connect failed: ');
                } else {
                   ...
                   $x=1;
                    ...
                    if ($conn) {
                        ...
                        $stmnt = "INSERT into saved (id, characterName, health, progress, experience, healthPotion) VALUES ($x ,$charN,$ht,$gp,$exp,$hp)";
